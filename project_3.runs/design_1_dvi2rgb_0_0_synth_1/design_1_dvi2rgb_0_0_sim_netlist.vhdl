...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2\ is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    PixelClk_int : in STD_LOGIC;
    \oSyncStages_reg[1]_0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2\ : entity is "SyncAsync";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_16\ is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    PixelClk_int : in STD_LOGIC;
    AS : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_16\ : entity is "SyncAsync";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_16\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_16\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_23\ is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    PixelClk_int : in STD_LOGIC;
    AS : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_23\ : entity is "SyncAsync";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_23\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_23\ is
  signal oSyncStages : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute async_reg : string;
  attribute async_reg of oSyncStages : signal is "true";
  attribute ASYNC_REG_boolean : boolean;
...
SyncAsyncx: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2\
     port map (
      D(0) => iIn_q,
      PixelClk_int => PixelClk_int,
...
begin
  ...
  iIn_q_reg_2 <= \^iin_q_reg_2\;
  iIn_q_reg_3 <= \^iin_q_reg_3\;
SyncAsyncx: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_16\
     port map (
      AS(0) => AS(0),
      D(0) => iIn_q_reg_n_0,
      PixelClk_int => PixelClk_int,
...
begin
  ...
  iIn_q_reg_2 <= \^iin_q_reg_2\;
  iIn_q_reg_3 <= \^iin_q_reg_3\;
SyncAsyncx: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SyncAsync__parameterized2_23\
     port map (
      AS(0) => AS(0),
      D(0) => iIn_q_reg_n_0,
      PixelClk_int => PixelClk_int,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TWI_SlaveCtl is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of DONE_O_i_2 : label is "soft_lutpair89";
  ...
  attribute SOFT_HLUTNM of \FSM_gray_state[1]_i_4\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \FSM_gray_state[1]_i_5\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_10\ : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_6\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \FSM_gray_state[2]_i_9\ : label is "soft_lutpair95";
  attribute KEEP : string;
  ...
  attribute SOFT_HLUTNM of \bitCount[1]_i_1\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of \bitCount[2]_i_1\ : label is "soft_lutpair86";
  ...
  attribute SOFT_HLUTNM of \dataByte[3]_i_1\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \dataByte[4]_i_1\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \dataByte[5]_i_1\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \dataByte[6]_i_1\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \dataByte[7]_i_2\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \sAddr_rep[0]_i_1\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \sAddr_rep[6]_i_1\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \sAddr_rep[7]_i_1\ : label is "soft_lutpair90";
begin
  rd_wrn_reg_0 <= \^rd_wrn_reg_0\;
  sI2C_Done <= \^si2c_done\;
DONE_O_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7F33333350000000"
    )
        port map (
      I0 => DONE_O_i_2_n_0,
      I1 => DONE_O_i_3_n_0,
...
\FSM_gray_state[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\FSM_gray_state[1]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F7F7F747"
    )
        port map (
...
\FSM_gray_state[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000F40000F4F400"
    )
        port map (
      I0 => dScl,
      I1 => ddScl,
      I2 => \FSM_gray_state[2]_i_6_n_0\,
      I3 => state(1),
      I4 => state(2),
      I5 => state(0),
...
\dataByte[7]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_EEPROM_8b is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sState[0]_i_1\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \sState[1]_i_1\ : label is "soft_lutpair96";
begin
