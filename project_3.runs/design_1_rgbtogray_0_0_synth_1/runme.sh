...
HD_PWD='C:/Users/CHA HANNA/project_3/project_3.runs/design_1_rgbtogray_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rgbtogray_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rgbtogray_0_0.tcl
