...
set rc [catch {
  ...
  set_property webtalk.parent_dir {C:/Users/CHA HANNA/project_3/project_3.cache/wt} [current_project]
  set src_rc [catch { 
    puts "source {C:/Users/CHA HANNA/Desktop/a.tcl}"
    source {C:/Users/CHA HANNA/Desktop/a.tcl}
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script {C:/Users/CHA HANNA/Desktop/a.tcl} failed"
    return -code error
  }
